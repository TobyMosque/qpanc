...
module.exports = function (ctx) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'QPANC App - Quasar, PostgreSQL and ASP.NET Core',
        short_name: 'QPANC App - Quasar, PostgreSQL and ASP.NET Core',
        description: 'QPANC App - Quasar, PostgreSQL and ASP.NET Core',
        display: 'standalone',
